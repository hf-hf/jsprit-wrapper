...
public class SimpleWrapperDemo {
    ...
    public static void main(String[] args) {
        // 说明是几座的车
        BasicVehicleType fourSeatVehicleType = new BasicVehicleType("0", 4);
        // 设置车辆可作业时间窗口
        ...
        Problem last = null;
        last = build(vehicleList, jobList1, last);
        vehicleList = null;
        ...
        last = build(vehicleList, jobList2, last);
        ...
        // third round start
        start = System.currentTimeMillis();
        last = build(vehicleList, jobList3, last);
        end = System.currentTimeMillis();
