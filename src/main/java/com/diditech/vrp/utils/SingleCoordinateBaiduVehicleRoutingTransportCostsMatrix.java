 ...
 * @date 2021/7/8 14:55
 */
public class SingleCoordinateBaiduVehicleRoutingTransportCostsMatrix extends AbstractForwardVehicleRoutingTransportCosts
    ...
    public SingleCoordinateBaiduVehicleRoutingTransportCostsMatrix(Map<String, Coordinate> locationMap, boolean isSymmetric) {
